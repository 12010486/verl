...
class ResourcePoolManager:
    ...
    def _check_resource_available(self):
        ...
        node_available_gpus = {node: node_info.get("GPU", 0) if "GPU" in node_info else node_info.get("NPU", 0) if "NPU" in node_info else node_info.get("HPU", 0) for node, node_info in node_available_resources.items()}
